...
public class Customer {
    ...
    // Agent to Customers, one agent to many customers
    @ManyToOne
    ...
    // Mapped by is how are we looping through our other data set
    // In this sense we are looking for the customers that populate our orders table
